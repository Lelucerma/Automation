...
class Stats(QDialog, Ui_Form):
    ...
    def init_signal_and_slot(self):
        ...
        self.pump3_reverse.clicked.connect(
            lambda: self.pump_open_reverse(3))
        ...
        self.pump4_reverse.clicked.connect(
            lambda: self.pump_open_reverse(4))
        ...
        self.pump5_reverse.clicked.connect(
            lambda: self.pump_open_reverse(5))
        ...
        self.pump6_reverse.clicked.connect(
            lambda: self.pump_open_reverse(6))
        ...
        self.pump7_reverse.clicked.connect(
            lambda: self.pump_open_reverse(7))
        ...
        self.pump8_reverse.clicked.connect(
            lambda: self.pump_open_reverse(8))
        ...
        self.pump9_reverse.clicked.connect(
            lambda: self.pump_open_reverse(9))
        ...
        self.pump10_reverse.clicked.connect(
            lambda: self.pump_open_reverse(10))
        ...
        self.pump11_reverse.clicked.connect(
            lambda: self.pump_open_reverse(11))
        ...
        self.pump12_reverse.clicked.connect(
            lambda: self.pump_open_reverse(12))
        ...
        self.pump13_reverse.clicked.connect(
            lambda: self.pump_open_reverse(13))
        ...
        self.pump14_reverse.clicked.connect(
            lambda: self.pump_open_reverse(14))
        ...
        self.pump15_reverse.clicked.connect(
            lambda: self.pump_open_reverse(15))
        ...
        self.pump16_reverse.clicked.connect(
            lambda: self.pump_open_reverse(16))
        ...
        self.pump17_reverse.clicked.connect(
            lambda: self.pump_open_reverse(17))
        ...
        # 开始脱保护单元的控制
        self.unit1_depro_start_button.clicked.connect(lambda: self.deprotect(1))
        self.unit2_depro_start_button.clicked.connect(lambda: self.deprotect(2))
        self.unit3_depro_start_button.clicked.connect(lambda: self.deprotect(3))
        self.unit4_depro_start_button.clicked.connect(lambda: self.deprotect(4))
        self.unit5_depro_start_button.clicked.connect(lambda: self.deprotect(5))
        ...
        self.unit2_couple_start_button.clicked.connect(lambda: self.couple_unit(2))
        self.unit3_couple_start_button.clicked.connect(lambda: self.couple_unit(3))
        self.unit4_couple_start_button.clicked.connect(lambda: self.couple_unit(4))
    ...
    def pump_open_reverse(self, add):
        ...
        11: {'spinbox': self.pump11_spinbox, 'suffix': '11 pump reverse'},
        12: {'spinbox': self.pump12_spinbox, 'suffix': '12 pump reverse'},
        13: {'spinbox': self.pump13_spinbox, 'suffix': '13 pump reverse'},
        14: {'spinbox': self.pump14_spinbox, 'suffix': '14 pump reverse'},
        15: {'spinbox': self.pump15_spinbox, 'suffix': '15 pump reverse'},
        16: {'spinbox': self.pump16_spinbox, 'suffix': '16 pump reverse'},
        }
