...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setMinimumSize(QSize(277, 246))
        self.frame.setMaximumSize(QSize(277, 246))
        self.frame.setSizeIncrement(QSize(277, 246))
        self.frame.setBaseSize(QSize(277, 246))
        self.frame.setLineWidth(0)
        self.gridLayout = QGridLayout(self.frame)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.wash_frequence = QSpinBox(self.frame)
        ...
        self.pressure_statrt = QPushButton(self.frame)
        self.pressure_statrt.setObjectName(u"pressure_statrt")

        self.gridLayout.addWidget(self.pressure_statrt, 5, 2, 1, 1)

        self.unit2_stop = QPushButton(self.frame)
        self.unit2_stop.setObjectName(u"unit2_stop")

        self.gridLayout.addWidget(self.unit2_stop, 3, 2, 1, 1)

        self.unit2_start = QPushButton(self.frame)
        self.unit2_start.setObjectName(u"unit2_start")

        self.gridLayout.addWidget(self.unit2_start, 3, 1, 1, 1)

        self.first_pressure_label = QLabel(self.frame)
        ...
        self.unit_start = QPushButton(self.frame)
        self.unit_start.setObjectName(u"unit_start")

        self.gridLayout.addWidget(self.unit_start, 0, 1, 1, 1)

        self.second_pressure_label = QLabel(self.frame)
        ...
        self.toolButton_6 = QToolButton(self.frame1)
        self.toolButton_6.setObjectName(u"toolButton_6")

        self.gridLayout_4.addWidget(self.toolButton_6, 3, 4, 1, 1)

        self.pump8_spinbox = QSpinBox(self.frame1)
        ...
        self.toolButton_5 = QToolButton(self.frame1)
        self.toolButton_5.setObjectName(u"toolButton_5")

        self.gridLayout_4.addWidget(self.toolButton_5, 2, 4, 1, 1)

        self.pump10_spinbox = QSpinBox(self.frame1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pressure_statrt.setText(QCoreApplication.translate("Form", u"\u5f00\u59cb\u538b\u529b\u6d4b\u91cf", None))
        ...
        self.connect_button.setText(QCoreApplication.translate("Form", u"\u7ed3\u675f", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"\u5f00\u59cb", None))
        self.unit_start.setText(QCoreApplication.translate("Form", u"\u5f00\u59cb", None))
